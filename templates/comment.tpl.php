...
<div class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="col-md-10"<?php print $content_attributes; ?>>
    <div class="comment-number pull-right"><?php print $permalink; ?></div>
    <div class="comment-author-info">
   		<p><span class="comment-title"><?php print $author ?></span> <em>Posted <?php print format_interval((time() - $comment->created) , 2) . t(' ago'); ?></em></p>
